...
profileOverlay: {
 ...
 width: "100%", 
  overflow: "hidden",
clipPath: ' polygon(-10% -10%, 40.25% 0%, 45.55% 2.84%, 49.82% 6.19%, 52.82% 10.72%, 54.55% 15.96%, 56.91% 22.18%, 59.28% 28.41%, 60.83% 35.07%, 64.6% 40.76%, 71.59% 43.4%, 100% 44.15%, 100% 150%, 0% 150%)',
